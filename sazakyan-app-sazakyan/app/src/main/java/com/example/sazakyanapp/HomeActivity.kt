...
import com.example.sazakyanapp.profile.EmailVerificationActivity  // (NEW) for Email
import com.example.sazakyanapp.profile.LoginActivity
import com.example.sazakyanapp.profile.VerificationActivity      // (NEW) for SMS
...
class HomeActivity : AppCompatActivity() {
    ...
    // NEW: Email & SMS Verification buttons
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // If using a toggle, override onOptionsItemSelected in the Activity
